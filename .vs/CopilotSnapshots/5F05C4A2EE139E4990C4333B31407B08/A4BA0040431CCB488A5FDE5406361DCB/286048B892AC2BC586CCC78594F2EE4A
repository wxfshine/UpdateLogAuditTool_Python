...
def get_request_digest():
    resp = session.post(f"{site_url}/_api/contextinfo", headers={
...
# ==============================================
# 上传 王晓峰验证文件 到 SharePoint
# ==============================================
print("\n" + "=" * 70)
print("📤 开始上传王晓峰验证文件到 SharePoint")
print("=" * 70)
...
try:
    ...
    print(f"✅ 已上传验证文件：{upload_file_name}")
    print(f"📂 上传目标目录：{wang_xiaofeng_folder}")
